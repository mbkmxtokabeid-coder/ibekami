    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-10 sm:mb-12">
            <div class="flex items-center gap-3 text-xs sm:text-[13px] font-bold text-[#b35200] uppercase tracking-[0.2em] mb-3">
                <?php echo e(__('messages.social_media')); ?>
            ...
            <a href="https://www.tiktok.com/@ibekami.id"
               ...
               class="bg-white p-5 sm:p-6 rounded-3xl border border-black/5 flex items-center gap-5 sm:gap-6 group
                ...
                <div class="w-14 h-14 sm:w-16 sm:h-16 bg-[#010101] rounded-2xl flex-shrink-0 flex items-center justify-center
                    ...
                    <img src="<?php echo e(asset('icons/tiktok.svg')); ?>"
                         alt="TikTok"
                         width="32" height="32"
                         loading="lazy"
            ...
            <a href="https://www.instagram.com/ibekami.id"
               ...
               class="bg-white p-5 sm:p-6 rounded-3xl border border-black/5 flex items-center gap-5 sm:gap-6 group
                ...
                <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex-shrink-0 flex items-center justify-center
                    ...
                    <img src="<?php echo e(asset('icons/instagram.svg')); ?>"
                         alt="Instagram"
                         width="32" height="32"
                         loading="lazy"
                         class="w-8 h-8 invert">
...
<?php /**PATH E:\3 MAGANG\IBEKAMI\ibekami_bckend\resources\views/livewire/halaman-utama/sosial-media.blade.php ENDPATH**/ ?>