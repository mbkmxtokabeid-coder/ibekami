    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-[#ffdbac]/85 backdrop-blur-xl border border-white/50 shadow-[0_8px_32px_rgba(255,145,0,0.05)] rounded-full px-4 sm:px-5 py-2.5 flex items-center justify-between transition-all duration-300"
            ...
            <a href="/" class="flex items-center gap-2.5 group shrink-0 outline-none">
                <img src="<?php echo e(asset('storage/logos/logo ibekami (3).webp')); ?>" 
                     alt="IBEKAMI Logo" 
                     width="36"
                     height="36"
            ...
            <div class="hidden lg:flex items-center gap-1 xl:gap-2">
                <a href="<?php echo e(url('/')); ?>" class="px-4 py-2 rounded-full text-[#5C3D28] text-[13px] xl:text-[14px] font-semibold hover:text-[#b35200] hover:bg-white/50 transition-all outline-none">
                    <?php echo e(__('messages.home')); ?>

                </a>
                <a href="<?php echo e(url('/#hot-deals')); ?>" 
                   ...
                   class="px-4 py-2 rounded-full text-[#5C3D28] text-[13px] xl:text-[14px] font-semibold hover:text-[#b35200] hover:bg-white/50 transition-all outline-none">
                    <?php echo e(__('messages.hot_deals')); ?>
                ...
                <div class="relative">
                    <button @click="catalogMenuOpen = !catalogMenuOpen" @click.outside="catalogMenuOpen = false" 
                            aria-label="<?php echo e(__('messages.catalog')); ?>, <?php echo e(app()->getLocale() === 'id' ? 'buka menu' : 'open menu'); ?>"
                    ...
                    <div x-show="catalogMenuOpen" x-cloak 
                        ...
                        <a href="<?php echo e(route('katalog')); ?>" class="block px-4 py-2.5 rounded-xl text-[14px] font-bold text-[#b35200] bg-[#fff2e0]/50 hover:bg-[#fff2e0] transition-colors mb-1"><?php echo e(__('messages.all_products')); ?></a>
                        
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $productTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <a href="<?php echo e(route('katalog', ['type' => $type['slug']])); ?>"
                               <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'desktop-type-'.e($type['id']).''; ?>wire:key="desktop-type-<?php echo e($type['id']); ?>"
                ...
                <a href="<?php echo e(route('mesin')); ?>" class="px-4 py-2 rounded-full text-[#5C3D28] text-[13px] xl:text-[14px] font-semibold hover:text-[#b35200] hover:bg-white/50 transition-all outline-none">
                    <?php echo e(__('messages.our_machines')); ?>
            ...
            <div class="flex items-center gap-2 xl:gap-3">
                ...
                <div class="relative shrink-0">
                    <button @click="langMenuOpen = !langMenuOpen" @click.outside="langMenuOpen = false" 
                            aria-label="<?php echo e(app()->getLocale() === 'id' ? 'ID - Pilih Bahasa' : 'EN - Choose Language'); ?>"
                ...
                <button @click="searchOpen = !searchOpen; mobileMenuOpen = false" 
                        aria-label="<?php echo e(__('messages.search_products')); ?>"
                ...
                <button @click="mobileMenuOpen = !mobileMenuOpen; searchOpen = false" 
                        aria-label="<?php echo e(app()->getLocale() === 'id' ? 'Buka Menu Navigasi' : 'Toggle Navigation'); ?>"
    ...
    <div x-show="mobileMenuOpen" x-cloak 
        ...
        <div class="bg-white/95 backdrop-blur-2xl border border-white/50 shadow-2xl rounded-3xl p-5 flex flex-col gap-2 max-h-[75vh] overflow-y-auto">
            <a href="<?php echo e(url('/')); ?>" 
               ...
               class="px-4 py-3 text-[#5C3D28] hover:bg-[#fff2e0]/80 hover:text-[#b35200] rounded-2xl font-semibold text-[15px] transition-colors"><?php echo e(__('messages.home')); ?></a>
            <a href="<?php echo e(url('/#hot-deals')); ?>" 
               ...
               class="px-4 py-3 text-[#5C3D28] hover:bg-[#fff2e0]/80 hover:text-[#b35200] rounded-2xl font-semibold text-[15px] transition-colors"><?php echo e(__('messages.hot_deals')); ?></a>
            ...
            <div class="bg-[#fff2e0]/40 rounded-2xl">
                ...
                <div x-show="catalogMenuOpen" x-cloak 
                    ...
                    <a href="<?php echo e(route('katalog')); ?>" class="px-3 py-2 rounded-xl bg-[#b35200]/10 text-[14px] font-bold text-[#b35200]"><?php echo e(__('messages.all_products')); ?></a>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $productTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <a href="<?php echo e(route('katalog', ['type' => $type['slug']])); ?>"
                           <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'mobile-type-'.e($type['id']).''; ?>wire:key="mobile-type-<?php echo e($type['id']); ?>"
            ...
            <a href="<?php echo e(route('mesin')); ?>" 
               @click="mobileMenuOpen = false;"
               class="px-4 py-3 text-[#5C3D28] hover:bg-[#fff2e0]/80 hover:text-[#b35200] rounded-2xl font-semibold text-[15px] transition-colors"><?php echo e(__('messages.our_machines')); ?></a>
            <a href="<?php echo e(url('/#footer')); ?>" 
...
<?php /**PATH E:\3 MAGANG\IBEKAMI\ibekami_bckend\resources\views/livewire/navbar.blade.php ENDPATH**/ ?>