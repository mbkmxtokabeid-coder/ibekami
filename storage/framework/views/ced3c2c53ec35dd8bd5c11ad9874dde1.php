...
<section id="hot-deals" class="py-16 md:py-24 px-4 bg-[#fdfaf7] relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-10 lg:mb-16">
            ...
            <a href="https://wa.me/6281707699999?text=Halo%20Admin%2C%20saya%20tertarik%20dengan%20produk%20dari%20Ibekami.id.%20Bisa%20bantu%20untuk%20info%20lebih%20lanjut%3F" 
               ...
               class="shrink-0 bg-white/50 backdrop-blur-sm border-2 border-[#b35200]/80 text-[#b35200] px-5 sm:px-6 py-3 sm:py-3.5 rounded-2xl text-[12px] sm:text-[13px] font-bold hover:bg-[#b35200] hover:text-white hover:border-[#b35200] hover:shadow-[0_8px_20px_rgba(179,82,0,0.25)] hover:-translate-y-1 transition-all duration-300 outline-none flex items-center justify-center gap-2 group w-full md:w-auto">
                <?php echo e(__('messages.ask_via_wa')); ?>
        ...
        >
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $deals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $deal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            <!-- Kartu Individu -->
            <a <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'deal-'.e($deal->id).''; ?>wire:key="deal-<?php echo e($deal->id); ?>"
               href="https://wa.me/6281707699999?text=Halo%20Admin%2C%20saya%20tertarik%20dengan%20produk%20<?php echo e(urlencode($deal->name)); ?>%20dari%20Ibekami.id.%20Bisa%20bantu%20untuk%20info%20lebih%20lanjut%3F"
               target="_blank"
               rel="noopener noreferrer"
               @click.throttle.2000ms
               @mouseenter="setHovered(<?php echo e($index); ?>)"
               @mouseleave="clearHovered()"
               :class="hoveredCard === <?php echo e($index); ?> ? 'scale-[1.02]' : ''"
               class="group bg-white rounded-[24px] sm:rounded-[32px] p-2 sm:p-2.5 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_40px_rgba(179,82,0,0.12)] border border-black/5 hover:border-[#b35200]/30 transition-all duration-500 hover:-translate-y-1 sm:hover:-translate-y-2 cursor-pointer flex flex-col h-full">
                ...
                <div class="relative h-[120px] sm:h-[200px] w-full rounded-t-[16px] sm:rounded-t-[24px] rounded-b-[32px] sm:rounded-b-[48px] overflow-hidden bg-[#fff2e0] mb-3 sm:mb-5">
                    ...
                    <img src="<?php echo e($deal->image_full_url); ?>" 
                    ...
                    <div 
                        x-show="hoveredCard === <?php echo e($index); ?>"
                    ...
                    >
                        <?php echo e(__('messages.ask_price')); ?>
                ...
                <div class="px-2 pb-3 sm:px-4 sm:pb-5 flex flex-col flex-1">
                    ...
                    <div class="mb-2 sm:mb-3" data-nosnippet>
                        <span class="inline-block bg-[#4a3728] text-white text-[9px] sm:text-[10px] font-bold px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-full uppercase tracking-widest shadow-md shadow-[#4a3728]/20">
                            <?php echo e(__('messages.hot_deal')); ?>
                    ...
                    <div class="mt-auto flex items-center text-[11px] sm:text-[12px] font-bold text-[#b35200] group-hover:text-[#2C1A0E] transition-colors">
                        <span class="truncate"><?php echo e(__('messages.ask_price')); ?></span> 
            ...
            <div class="col-span-2 lg:col-span-4 text-center py-12">
                <div class="flex flex-col items-center gap-4">
                    ...
                    <p class="text-[#886852] font-medium"><?php echo e(__('messages.no_product_types')); ?></p>
                </div>
            </div>
...
<?php /**PATH E:\3 MAGANG\IBEKAMI\ibekami_bckend\resources\views/livewire/halaman-utama/hot-deals.blade.php ENDPATH**/ ?>