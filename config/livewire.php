...
return [
    ...
    */
    ...
    'component_locations' => [
        ...
        resource_path('views/admin/menu'),
        resource_path('views/admin/menu/frontend'),
    ],
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        'rules' => ['required', 'file', 'max:102400'],        // Max 100MB di level Livewire (untuk video banner)
                                                              // Validasi per-komponen (2MB untuk gambar) ada di rules() masing-masing
