                ...
                <div class="border border-gray-200 rounded-lg p-5 space-y-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">
                            {{ $isEditing ? 'Update Gambar Banner' : 'Upload Gambar Banner' }}
                        ...
                        <div class="mt-2 space-y-1">
                            <p class="text-xs text-[#FF9100]">
                                🖼️ <strong>Info Gambar:</strong> Format jpg/png/webp — maks <strong>2MB</strong>, rasio disarankan <strong>1:1 (Square)</strong> agar presisi pada frame banner utama.
                            </p>
                            <p class="text-xs text-gray-400">
                                💡 Gambar yang diunggah akan secara otomatis dikompresi ke format <strong>WebP (<50KB)</strong> untuk performa loading super cepat.
                            </p>
                        </div>
