    ...
    <div class="max-w-7xl mx-auto">
        ...
        >
            ...
            <a 
                ...
                class="bg-white p-5 sm:p-6 rounded-3xl border border-[#b35200]/10 flex items-center gap-5 sm:gap-6 group hover:border-[#b35200]/40 hover:shadow-[0_8px_30px_rgba(179,82,0,0.12)] transition-all duration-300 hover:scale-[1.02] ease-out"
            >
                <!-- Logo Tokopedia -->
                <div class="w-14 h-14 sm:w-16 sm:h-16 bg-[#fff2e0] rounded-2xl flex-shrink-0 flex items-center justify-center group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-300 ease-out border border-[#b35200]/5 overflow-hidden p-2">
